...
export default function WatingMembetList(){
    ...
    return (
        <Container>
            ...
            {memberList.getAllMembers().map((member, index) => (
                <WaitingMemberComponent key={index} name={member.name} studentId={member.studentId} phoneNo={member.phoneNumber} attendanceScore={member.attendanceScore} department={member.department} tags={member.tags}></WaitingMemberComponent>
            ))}
        </Container>
    )
}
