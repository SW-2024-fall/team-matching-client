    ...
    return (
        <Container>
            ...
            {memberList.getAllMembers().map((member, index) => (
                <MemberComponent key={index} name={member.name} studentId={member.studentId} phoneNo={member.phoneNumber} attendanceScore={member.attendanceScore} department={member.department} tags={member.tags}></MemberComponent>
            ))}
        </Container>
    )
}
