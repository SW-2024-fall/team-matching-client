...
const DATA = [
  ...
  { id: '4', name: '모임 이름 2', features: ['#문화', '#여행'], currentParticipants: '12명', maxParticipants: '25명', startDate: '2020.05.05', endDate: '2024.1.2', likeCount: '39', commentCount: '1', preview: '문화 관련 모임으로 다양한 여행 정보를 공유합니다.', image: null },
  { id: '5', name: '모임 이름 3', features: ['#스포츠'], currentParticipants: '8명', maxParticipants: '15명', startDate: '2020.06.06', endDate: '2024.1.2', likeCount: '93', commentCount: '1', preview: '스포츠 관련 모임으로 매주 모여서 운동을 합니다.', image: null }
];
